package com.mycompany.listacircularduplamenteligada;
...
public class ListaCircularDuplamenteLigada {
    ...
    public void adicionar(Object item){
     ...
     public NoDuplo adicionar(Object item, int indice){
        ...
        /* ****Implemente o código necessário para permitir adicionar em qualquer posição da lista *****/
     ...
     public void remover(int indice){
        ...
        if((indice%qtdNos)==0 ){
            ...
            /**********Implemente o código que permita remover de qualquer outra posição da lista **********/
