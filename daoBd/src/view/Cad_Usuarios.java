...
public class Cad_Usuarios extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (operacaoAtivaGlobal.equals(operacao)) {            
            ...
            objcon.alterarRegistroJFBD("USUARIOS", dados_usuarios.alterarRegistroJFBD(), "ID=" + jTextField1.getText());
        ...
        if (operacaoAtivaGlobal.equals(operacao)) {
            ...
            JOptionPane.showMessageDialog(null, "variável global: "+operacaoAtivaGlobal);
            connectDAO objcon = new connectDAO();
            usuarios_tela = objcon.pesquisaUsuariosJFBD("USUARIOS", "ID = '" + jTextField1.getText() + "'");
            jTextField2.setText(usuarios_tela.getSenha());
            jTextField3.setText(usuarios_tela.getNumAge());
            jTextField4.setText(usuarios_tela.getNumCc());
        ...
        if (operacaoAtivaGlobal.equals(operacao)) {
            ...
            objcon.excluiRegistroJFBD("USUARIOS", dados_usuario.ExcluiDadosSQLValues(), "ID=" + jTextField1.getText());
